...
void buy_a(int a){
     ...
     cout<<"\n\t-Enter the amount of card: ";
     cin>>c;
     cout<<"\n\t\t------Successfully "<<c<<" amount of card is buy to "<<a;
}
 void cbe(){
    int c,x;
    string yu,fa,z;
    cout<<"\t\t-Enter your CBE account"<<endl;
    cin>>c;
    ifstream open("cbe.txt");
